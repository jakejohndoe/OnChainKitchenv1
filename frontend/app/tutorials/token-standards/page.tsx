    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-teal-50">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Token Standards Explained</h1>
        ...
        {/* What Are Standards */}
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">📐 What Are Token Standards?</h2>
        ...
        {/* ERC-20 */}
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">💵 ERC-20: Digital Dollars</h2>
        ...
        {/* ERC-721 */}
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">🎨 ERC-721: Unique Trading Cards</h2>
        ...
        {/* ERC-1155 */}
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">🎒 ERC-1155: The Ultimate Backpack</h2>
        ...
        <div className="bg-gradient-to-br from-yellow-100 to-orange-100 rounded-2xl shadow-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">🍳 How On-Chain Kitchen Uses All Three!</h2>
        ...
        <div className="bg-gradient-to-r from-green-100 to-teal-100 rounded-2xl shadow-lg p-8">
          <div className="text-center">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">Ready to Experience It All? 🎉</h3>
