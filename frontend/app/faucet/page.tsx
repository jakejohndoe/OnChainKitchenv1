          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border border-green-200 text-center">
              ...
              <p className="text-green-700 mb-4">
                Once you have tokens, head to the Shop to buy ingredients for cooking!
              </p>
              <button
                disabled
                className="bg-green-200 text-green-800 px-6 py-2 rounded-lg font-medium opacity-50 cursor-not-allowed"
              >
